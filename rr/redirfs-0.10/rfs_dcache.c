		...
		struct rfs_info *rinfo, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_data_alloc");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_data_free");
	/****/
		...
		struct dentry *dentry, struct list_head *list)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_entry_alloc_locked");
	/****/
...
static void rfs_dcache_entry_free(struct rfs_dcache_entry *entry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_entry_free");
	/****/
		...
		struct list_head *sibs)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_get_subs_atomic");
	/****/
		...
		struct list_head *sibs)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_get_subs_kernel");
	/****/
...
int rfs_dcache_get_subs(struct dentry *dir, struct list_head *sibs)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_get_subs");
	/****/
...
void rfs_dcache_entry_free_list(struct list_head *head)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_entry_free_list");
	/****/
...
static int rfs_dcache_get_subs_mutex(struct dentry *dir, struct list_head *sibs)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_get_subs_mutex");
	/****/
...
static int rfs_dcache_get_dirs(struct list_head *dirs, struct list_head *sibs)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_get_dirs");
	/****/
		...
		void *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_walk");
	/****/
...
static int rfs_dcache_skip(struct dentry *dentry, struct rfs_dcache_data *rdata)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_skip");
	/****/
...
int rfs_dcache_rdentry_add(struct dentry *dentry, struct rfs_info *rinfo)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_rdentry_add");
	/****/
...
int rfs_dcache_rinode_del(struct rfs_dentry *rdentry, struct inode *inode)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_rinode_del");
	/****/
...
static int rfs_dcache_rdentry_del(struct dentry *dentry, struct rfs_info *rinfo)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_rdentry_del");
	/****/
...
int rfs_dcache_add_dir(struct dentry *dentry, void *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_add_dir");
	/****/
	if (!dentry->d_inode)
		return 0;
...
int rfs_dcache_add(struct dentry *dentry, void *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_add");
	/****/
...
int rfs_dcache_rem(struct dentry *dentry, void *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_rem");
	/****/
...
int rfs_dcache_set(struct dentry *dentry, void *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_set");
	/****/
...
int rfs_dcache_reset(struct dentry *dentry, void *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dcache.c // rfs_dcache_reset");
	/****/
