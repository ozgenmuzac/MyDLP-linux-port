		...
		struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_alloc");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_get");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_put");
	/****/
		...
		struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_find");
	/****/
...
struct rfs_path *rfs_path_find_id(int id)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_find_id");
	/****/
...
static int rfs_path_add_rroot(struct rfs_path *rpath)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_add_rroot");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_rem");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_list_add");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_list_rem");
	/****/
...
static int rfs_path_get_id(void)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_get_id");
	/****/
		...
		struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_add");
	/****/
...
static int rfs_path_add_dirs(struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_add_dirs");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_check_fs");
	/****/
...
static int rfs_path_add_include(struct rfs_path *rpath, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_add_include");
	/****/
...
static int rfs_path_add_exclude(struct rfs_path *rpath, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_add_exclude");
	/****/
...
static int rfs_path_rem_include(struct rfs_path *rpath, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_rem_include");
	/****/
...
static int rfs_path_rem_exclude(struct rfs_path *rpath, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_rem_exclude");
	/****/
		...
		struct redirfs_path_info *info)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_add_path");
	/****/
...
int redirfs_rem_path(redirfs_filter filter, redirfs_path path)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_rem_path");
	/****/
...
int redirfs_get_id_path(redirfs_path path)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_get_id_path");
	/****/
...
redirfs_path redirfs_get_path_id(int id)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_get_path_id");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_get_path");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_put_path");
	/****/
...
redirfs_path* redirfs_get_paths_root(redirfs_filter filter, redirfs_root root)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_get_paths_root");
	/****/
...
redirfs_path* redirfs_get_paths(redirfs_filter filter)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_get_paths");
	/****/
...
void redirfs_put_paths(redirfs_path *paths)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_put_paths");
	/****/
		...
		redirfs_path path)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_get_path_info");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_put_path_info");
	/****/
...
int redirfs_rem_paths(redirfs_filter filter)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_rem_paths");
	/****/
...
int rfs_path_get_info(struct rfs_flt *rflt, char *buf, int size)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_path_get_info");
	/****/
		...
		int size)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // redirfs_get_filename");
	/****/
		...
		struct rfs_chain *rchain)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_fsrename_rem_rroot");
	/****/
		...
		struct rfs_chain *rchain, struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_fsrename_rem_dentry");
	/****/
		...
		struct rfs_root *rroot_dst, struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_fsrename_rem");
	/****/
		...
		struct rfs_chain *rchain)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_fsrename_add_rroot");
	/****/
...
{	
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_fsrename_add_dentry");
	/****/
		...
		struct rfs_root *rroot_dst, struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_fsrename_add");
	/****/
		...
		struct rfs_root *rroot_dst, struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_fsrename_set");
	/****/
		...
		struct inode *new_dir, struct dentry *new_dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_path.c // rfs_fsrename");
	/****/
