...
static int rfs_info_add_ops(struct rfs_info *rinfo, struct rfs_chain *rchain)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_add_ops");
	/****/
		...
		struct rfs_chain *rchain)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_alloc");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_get");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_put");
	/****/
...
static struct rfs_info *rfs_info_dentry(struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_dentry");
	/****/
...
struct rfs_info *rfs_info_parent(struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_parent");
	/****/
...
static int rfs_info_rdentry_add(struct rfs_info *rinfo)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_rdentry_add");
	/****/
...
static void rfs_info_rdentry_rem(struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_rdentry_rem");
	/****/
		...
		struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_add");
	/****/
		...
		struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_rem");
	/****/
		...
		struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_set");
	/****/
...
int rfs_info_reset(struct dentry *dentry, struct rfs_info *rinfo)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_reset");
	/****/
...
int rfs_info_add_include(struct rfs_root *rroot, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_add_include");
	/****/
...
int rfs_info_add_exclude(struct rfs_root *rroot, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_add_exclude");
	/****/
...
int rfs_info_rem_include(struct rfs_root *rroot, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_rem_include");
	/****/
...
int rfs_info_rem_exclude(struct rfs_root *rroot, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_info.c // rfs_info_rem_exclude");
	/****/
