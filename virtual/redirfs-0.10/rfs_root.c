...
static struct rfs_root *rfs_root_alloc(struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_alloc");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_get");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_put");
	/****/
...
static struct rfs_root *rfs_root_find(struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_find");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_list_add");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_list");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_add_rpath");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_rem_rpath");
	/****/
...
struct rfs_root *rfs_root_add(struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_add");
	/****/
		...
		int type)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_flt_num");
	/****/
...
int rfs_root_add_include(struct rfs_root *rroot, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_add_include");
	/****/
...
int rfs_root_add_exclude(struct rfs_root *rroot, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_add_exclude");
	/****/
...
int rfs_root_rem_include(struct rfs_root *rroot, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_rem_include");
	/****/
...
int rfs_root_rem_exclude(struct rfs_root *rroot, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_rem_exclude");
	/****/
...
int rfs_root_add_flt(struct rfs_root *rroot, void *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_add_flt");
	/****/
...
int rfs_root_rem_flt(struct rfs_root *rroot, void *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_rem_flt");
	/****/
...
int rfs_root_walk(int (*cb)(struct rfs_root *, void *), void *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_walk");
	/****/
...
void rfs_root_add_walk(struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_add_walk");
	/****/
		...
		struct rfs_info *rinfo_start)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_get_root_flt");
	/****/
...
redirfs_root redirfs_get_root_file(redirfs_filter filter, struct file *file)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_get_root_file");
	/****/
		...
		struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_get_root_dentry");
	/****/
...
redirfs_root redirfs_get_root_inode(redirfs_filter filter, struct inode *inode)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // redirfs_get_root_inode");
	/****/
...
redirfs_root redirfs_get_root_path(redirfs_path path)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_root.c // redirfs_get_root_path");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_root.c // redirfs_get_root");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_put_root");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_root.c // rfs_root_set_rinfo");
	/****/
