...
static struct rfs_dentry *rfs_dentry_alloc(struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_alloc");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_get");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_put");
	/****/
...
struct rfs_dentry *rfs_dentry_add(struct dentry *dentry, struct rfs_info *rinfo)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_add");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_del");
	/****/
...
int rfs_dentry_add_rinode(struct rfs_dentry *rdentry, struct rfs_info *rinfo)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_add_rinode");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_rem_inode");
	/****/
...
struct rfs_info *rfs_dentry_get_rinfo(struct rfs_dentry *rdentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_get_rinfo");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_set_rinfo");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_add_rfile");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_rem_file");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_cache_create");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_cache_destroy");
	/****/
...
void rfs_d_iput(struct dentry *dentry, struct inode *inode)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_d_iput");
	/****/
...
static void rfs_d_release(struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_d_release");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_d_compare_default");
	/****/
		...
		struct qstr *name2)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_d_compare");
	/****/
...
static int rfs_d_revalidate(struct dentry *dentry, struct nameidata *nd)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_d_revalidate");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_set_ops_none");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_set_ops_reg");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_set_ops_dir");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_set_ops_lnk");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_set_ops_chr");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_set_ops_blk");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_set_ops_fifo");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_set_ops_sock");
	/****/
...
void rfs_dentry_set_ops(struct rfs_dentry *rdentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_set_ops");
	/****/
...
void rfs_dentry_rem_data(struct dentry *dentry, struct rfs_flt *rflt)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_rem_data");
	/****/
		...
		struct rfs_root *src, struct rfs_root *dst)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_dentry.c // rfs_dentry_move");
	/****/
