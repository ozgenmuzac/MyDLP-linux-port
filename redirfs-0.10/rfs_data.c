...
void rfs_data_remove(struct list_head *head)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // rfs_data_remove");
	/****/
		...
		void (*detach)(struct redirfs_data *))
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_init_data");
	/****/
...
struct redirfs_data *redirfs_get_data(struct redirfs_data *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_get_data");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_put_data");
	/****/
		...
		redirfs_filter filter)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_find_data");
	/****/
		...
		struct file *file, struct redirfs_data *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_attach_data_file");
	/****/
		...
		struct file *file)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_detach_data_file");
	/****/
		...
		struct file *file)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_get_data_file");
	/****/
		...
		struct dentry *dentry, struct redirfs_data *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_attach_data_dentry");
	/****/
		...
		struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_detach_data_dentry");
	/****/
		...
		struct dentry *dentry)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_get_data_dentry");
	/****/
		...
		struct inode *inode, struct redirfs_data *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_attach_data_inode");
	/****/
		...
		struct inode *inode)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_detach_data_inode");
	/****/
		...
		struct inode *inode)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_get_data_inode");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_data.c // rfs_context_init");
	/****/
...
{
	/****/
	/*printk(KERN_INFO "rfs_data.c // rfs_context_deinit");
	/****/
		...
		redirfs_context context, struct redirfs_data *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_attach_data_context");
	/****/
		...
		redirfs_context context)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_detach_data_context");
	/****/
		...
		redirfs_context context)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_get_data_context");
	/****/
		...
		redirfs_root root, struct redirfs_data *data)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_attach_data_root");
	/****/
		...
		redirfs_root root)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_detach_data_root");
	/****/
		...
		redirfs_root root)
{
	...
	/****/
	/*printk(KERN_INFO "rfs_data.c // redirfs_get_data_root");
	/****/
